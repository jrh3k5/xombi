...
describe('MemoryRequestTracker', () => {
  ...
  describe('trackRequest', () => {
    it('should track a movie request', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('Tracking movie request movie123 for 0x1234567890abcdef');
    });
    ...
    it('should track a TV request', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('Tracking tv request tv456 for 0xfedcba0987654321');
    });
  ...
  describe('removeRequest', () => {
    it('should remove existing request', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('Removed tracking for request movie123');
    });

    it('should not log removal for non-existent request', () => {
      tracker.removeRequest('nonexistent');
      
      expect(console.log).not.toHaveBeenCalledWith(expect.stringContaining('Removed tracking'));
    });
  });
  ...
  describe('cleanup', () => {
    it('should remove requests older than specified days', () => {
      ...
      expect(console.log).toHaveBeenCalledWith('Cleaned up 1 old tracked requests');
