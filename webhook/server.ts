...
export class WebhookServer {
  ...
  private notificationHandler?: (address: string, message: string) => Promise<void>;
  ...
  private async handleAvailabilityNotification(payload: WebhookPayload) {
    ...
    try {
      ...
      console.error(`Failed to send notification to ${requesterAddress}:`, error);
    }
  }
  ...
  public setNotificationHandler(handler: (address: string, message: string) => Promise<void>) {
